...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('contents', '0002_remove_products_product_image'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_category', models.ForeignKey(default='11', on_delete=django.db.models.deletion.CASCADE, related_name='product_category_set', to='contents.category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_image', to='contents.product')),
            ],
        ),
        migrations.RemoveField(
            model_name='prouctimages',
            name='product_id',
        ),
